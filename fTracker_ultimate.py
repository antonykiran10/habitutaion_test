...
video_folder = '/home/antony/projects/habituation_saunri/test 001_27-02-2024/control 6_wells/'
video_name = '0_0.avi'
input_video_link = video_folder + video_name

output_video_link = video_folder + 'motion_selected_' + video_name

threshold = 50 #Threshold for the MOG2 algorithm
fps = 120
...
for filename in series:
    ...
    if filename.endswith('.bmp'):
        ...
        points_x, points_y = ft.fish_hunter(5, 30, skeleton_image, head_x, head_y, centroid_x, centroid_y, number_of_points)
